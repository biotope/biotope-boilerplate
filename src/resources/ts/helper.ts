...
biotope.configuration.set('biotope.iOS', navigator.userAgent.match(/(iPad|iPhone|iPod)/g).length > 0 && !navigator.userAgent.match(/(Windows Phone)/g));
...
// detect IE mobile
biotope.configuration.set('biotope.IEMobile', navigator.userAgent.match(/iemobile/i).length > 0);
...
biotope.configuration.set('biotope.touch', (
