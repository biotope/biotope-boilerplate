...
import {BoilerplateState, createInitialBoilerplateState} from './BoilerplateState';
...
if (!customElements.get('biotope-boilerplate')) {
	customElements.define('biotope-boilerplate', Boilerplate);
}
